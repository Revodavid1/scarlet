                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="left">
                                                                                        <h1 style="color: #4a7eb0;">New Contact Form Submitted</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p20b" align="left"> 
                                                                                        <span class="es-button-border"> <strong>Name:</strong> <?= $contact_name?> </span> 
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p20b" align="left"> 
                                                                                        <span class="es-button-border"> <strong>Email:</strong> <?= $contact_email?> </span> 
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p20b" align="left"> 
                                                                                        <span class="es-button-border"> <strong>Message:</strong> <?= $contact_message?> </span> 
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
